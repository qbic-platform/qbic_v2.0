...
RESOURCES += src/qt/qbiccoin.qrc src/qt/qbiccoin_locale.qrc

TRANSLATIONS += src/qt/locale/qbiccoin_bg.ts \
                src/qt/locale/qbiccoin_de.ts \
                src/qt/locale/qbiccoin_en.ts \
                src/qt/locale/qbiccoin_es.ts \
                src/qt/locale/qbiccoin_fi.ts \
                src/qt/locale/qbiccoin_fr.ts \
                src/qt/locale/qbiccoin_it.ts \
                src/qt/locale/qbiccoin_ja.ts \
                src/qt/locale/qbiccoin_pl.ts \
                src/qt/locale/qbiccoin_pt.ts \
                src/qt/locale/qbiccoin_ru.ts \
                src/qt/locale/qbiccoin_sk.ts \
                src/qt/locale/qbiccoin_sv.ts \
                src/qt/locale/qbiccoin_vi.ts \
                src/qt/locale/qbiccoin_zh_CN.ts \
                src/qt/locale/qbiccoin_zh_TW.ts
