...
pkgdatadir = $(datadir)/qbiccoin
pkgincludedir = $(includedir)/qbiccoin
pkglibdir = $(libdir)/qbiccoin
pkglibexecdir = $(libexecdir)/qbiccoin
...
CONFIG_HEADER = $(top_builddir)/src/config/qbiccoin-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/qbiccoin-config.h.in \
...
ACLOCAL = ${SHELL} /home/beast/crypto/QBICcoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/beast/crypto/QBICcoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/beast/crypto/QBICcoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/beast/crypto/QBICcoin/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = qbiccoin-cli
BITCOIN_DAEMON_NAME = qbiccoind
BITCOIN_GUI_NAME = qbiccoin-qt
BITCOIN_TX_NAME = qbiccoin-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/beast/crypto/QBICcoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL64 = 
PACKAGE = qbiccoin
PACKAGE_BUGREPORT = www.qbiccoin.cc
PACKAGE_NAME = qbiccoin Core
PACKAGE_STRING = qbiccoin Core 1.0.1
PACKAGE_TARNAME = qbiccoin
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/beast/crypto/QBICcoin
abs_srcdir = /home/beast/crypto/QBICcoin
abs_top_builddir = /home/beast/crypto/QBICcoin
abs_top_srcdir = /home/beast/crypto/QBICcoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/beast/crypto/QBICcoin/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_qbiccoin_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_qbiccoin_coverage.info test_qbiccoin.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/QBICcoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/qbiccoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/qbiccoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/qbiccoin-config.h
$(top_srcdir)/src/config/qbiccoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/qbiccoin-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/QBICcoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/QBICcoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/QBICcoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_qbiccoin.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_qbiccoin -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_qbiccoin_filtered.info: test_qbiccoin.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_qbiccoin_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_qbiccoin_coverage.info: baseline_filtered_combined.info test_qbiccoin_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_qbiccoin_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_qbiccoin_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_qbiccoin_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_qbiccoin.coverage/.dirstamp:  test_qbiccoin_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_qbiccoin.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_qbiccoin.coverage/ total.coverage/ $(OSX_APP)
