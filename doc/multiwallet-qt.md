...
In order to support loading of multiple wallets in qbiccoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is qbiccoin.cpp.
...
Changes to qbiccoin.cpp
----------------------
qbiccoin.cpp is the entry point into qbiccoin-qt, and as such, will require some minor modifications to provide hooks for
