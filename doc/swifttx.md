...
This mechanism has been integrated into Bitcore-Node-QBICcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/QBICcoin-Project/insight-api-qbiccoin#web-socket-api](https://github.com/QBICcoin-Project/insight-api-qbiccoin#web-socket-api) 
* API: [https://github.com/QBICcoin-Project/insight-api-qbiccoin#swifttx-transactions](https://github.com/QBICcoin-Project/insight-api-qbiccoin#swifttx-transactions) 
...
By default, the QBICcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the QBICcoin Core daemon:
