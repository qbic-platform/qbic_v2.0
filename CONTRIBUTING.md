Contributing to QBICcoin Core
============================

The QBICcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the QBICcoin Core project, and is not to be
confused with overall QBICcoin Network Protocol consensus changes.

Whether a pull request is merged into QBICcoin Core rests with the project merge
...
Patches that change QBICcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the QBICcoin consensus, it must have been
...
The project leader is the release manager for each QBICcoin Core release.
