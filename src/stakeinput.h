...
#ifndef QBICcoin_STAKEINPUT_H
#define QBICcoin_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZQBIC() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zQBICStake can take two forms
...
public:
    ...
    bool IsZQBIC() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZQBIC() override { return false; }
};


#endif //QBICcoin_STAKEINPUT_H
