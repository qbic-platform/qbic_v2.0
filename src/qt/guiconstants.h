...
/* qbiccoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "QBICcoin"
#define QAPP_ORG_DOMAIN "qbiccoin.cc"
#define QAPP_APP_NAME_DEFAULT "QBICcoin-Qt"
#define QAPP_APP_NAME_TESTNET "QBICcoin-Qt-testnet"
