...
/** Utility functions used by the QBICcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render QBICcoin addresses in monospace font
...
// Parse "qbiccoin:" URI into recipient object, return true on successful parsing
