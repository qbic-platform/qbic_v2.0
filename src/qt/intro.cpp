...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("QBICcoin Core"),
     ...
     * override -datadir in the qbiccoin.conf file in the default data directory
     * (to be consistent with qbiccoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
