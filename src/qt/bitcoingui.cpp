                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("QBICcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a QBICcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and qbiccoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zQBIC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About QBICcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about QBICcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for QBICcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your QBICcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified QBICcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a QBICcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the QBICcoin Core help message to get a list with possible QBICcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("QBICcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to QBICcoin network", "", count));
}
...
{
    QString strTitle = tr("QBICcoin Core"); // default title
