/* src/config/qbiccoin-config.h.  Generated from qbiccoin-config.h.in by configure.  */
/* src/config/qbiccoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef QBIC_CONFIG_H

#define QBIC_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.qbiccoin.cc"

/* Define to the full name of this package. */
#define PACKAGE_NAME "qbiccoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "qbiccoin Core 1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "qbiccoin"
