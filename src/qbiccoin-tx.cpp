...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("qbiccoin Core qbiccoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  qbiccoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded qbiccoin transaction") + "\n" +
                               "  qbiccoin-tx [options] -create [commands]   " + _("Create hex-encoded qbiccoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded qbiccoin transaction
