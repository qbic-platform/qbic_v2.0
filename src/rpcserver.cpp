...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop QBICcoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "QBICcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* QBICcoin features */
        {"qbiccoin", "masternode", &masternode, true, true, false},
        {"qbiccoin", "listmasternodes", &listmasternodes, true, true, false},
        {"qbiccoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"qbiccoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"qbiccoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"qbiccoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"qbiccoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"qbiccoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"qbiccoin", "masternodedebug", &masternodedebug, true, true, false},
        {"qbiccoin", "startmasternode", &startmasternode, true, true, false},
        {"qbiccoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"qbiccoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"qbiccoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"qbiccoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"qbiccoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"qbiccoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"qbiccoin", "mnbudget", &mnbudget, true, true, false},
        {"qbiccoin", "preparebudget", &preparebudget, true, true, false},
        {"qbiccoin", "submitbudget", &submitbudget, true, true, false},
        {"qbiccoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"qbiccoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"qbiccoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"qbiccoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"qbiccoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"qbiccoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"qbiccoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"qbiccoin", "checkbudgets", &checkbudgets, true, true, false},
        {"qbiccoin", "mnsync", &mnsync, true, true, false},
        {"qbiccoin", "spork", &spork, true, true, false},
        {"qbiccoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> qbiccoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:37196/\n";
}
